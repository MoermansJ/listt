  ...
  return (
    <div className="main-grid">
      ...
      <div className="image-overlay">
        ...
        <div className="text">
          Healthy soils produce healthy food and require less inputs. It’s good
          business when your food production uses less resources, farmers are{" "}
          <span className="bold">more in control</span> over their economics and
          less reliant on long supply chains.
        </div>

        <div className="text">
          At Listt we provide the appropriate technology solutions for
          regeneration, and prioritise soil health while building thriving food
          production businesses. From traditional IT solutions to connected
          sensors for measuring soil and crop health, or even advanced
